from app.agent.tools.shared import SupabaseClient, err_msg
...
from app.agent.tools.template_tools import list_templates, get_template, generate_payment_message
from app.agent.tools.timetable_tools import (
...
__all__ = [
    ...
    "setup_student_google", "run_sync_all", "get_schedule", "get_fee_summary",
